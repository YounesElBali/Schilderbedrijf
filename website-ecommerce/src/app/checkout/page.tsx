...
export default function CheckoutPage() {
  ...
  }, [paymentMethod, cart, getTotalPrice]);
  ...
  //     const email = formData.get('email') as string;
  //     const amount = Math.round(getTotalPrice() * 100); // In cents
  ...
  //         const result = await fetch('/api/create-payment-session', {
  //           method: 'POST',
  //           headers: { 'Content-Type': 'application/json' },
  ...
  //         } else if (data.resultCode === 'Authorised') {
  //           await handleOrderCompletion(data.pspReference);
  //         } else {
  ...
  //       paymentMethodsResponse: paymentResponse.paymentMethods,
  ...
  //     setError('Er ging iets mis tijdens het verwerken van de betaling.');
  //   }
  // };
